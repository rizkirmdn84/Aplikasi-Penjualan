<form action="<?= base_url('barang/simpanharga'); ?>" class="formHarga" method="post">
    <div class="form-group mb-3">
        <input type="text" readonly class="form-control" name="kodeharga" id="kodeharga" placeholder="Input Kode Harga">
    </div>
    <div class="form-group mb-3">
